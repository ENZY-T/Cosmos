...
const LiveEditorNew = ({match}: RouteComponentProps<IMatchParams>) => {
    ...
    const sendData = async () => {
        ...
        Object.entries(savingProject).map((item) => {
            ...
            if (item[1] !== '' && item[0] !== 'mediaURIs') formData.append(item[0], item[1])
        })
        await axios
    ...
    return (
        <div className={Classes.view}>
            ...
            <div className={Classes.inlineGallery}>
                <XCarousel
                    itemList={editedProject.mediaURIs}
                />
            </div>
            ...
            <Link className={Classes.adminLiveEditLink} to={`/projects/${match.params.id}`}>
            ...
            {isEditBoxOpen && (
                <EditBox itemType={'Project'} adminItem={project} isFullWidth setFormVisibility={setEditBoxOpen}/>)}
        </div>
    )
}
...
const adminItem: IAdminItem = {
    createdDate: "", description: "", id: "", mediaURIs: [], tagline: "", title: ""
