...
const dummyItem = {
    createdDate: "", description: "", id: "", mediaType: "", mediaURIs: [], tagline: "", title: ""
}
...
const AdminForm = (props) => {
    ...
    return (<main className={Classes.main} style={props.isFullWidth ? mainStyleMore : undefined}>
                ...
                <div className={Classes.contentWrapper}>
                    ...
                    <div className={Classes.fileHandlerWrapper}>
                        <div id='image-stock' className={Classes.imageStock}>
                            {(!item.mediaURIs?.length && !images?.length) && (<h6>No image files selected ...</h6>)}
