...
const NavMenu = () => {
    ...
    let navLinkStatusDefault: INavLinkStatus = {
        home: 'inactive', about: 'inactive',
        contactus: 'inactive', gallery: 'inactive'
    }
    ...
    return (
        <nav className="nav nav-masthead justify-content-center">
            <Link to='/' className={`nav-link ${navLinkStatus.home}`}>Home</Link>
            ...
            <Link to='/cosmos/about/' className={`nav-link ${navLinkStatus.about}`}>About</Link>
        </nav>
    );
};
