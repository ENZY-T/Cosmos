...
const StaticPageHost = () => {
    ...
    const titleJsx = () => {
        switch (activePage) {
            ...
            case 'about':
                return (<HeadingGreenBoxed titleGreen={'About'} titleRaw={'Us'}
                                           className={'ab-center fontSize-onMobile rem-2_5 w-100'}/>)
            case 'gallery':
                return (
                    <HeadingGreenBoxed titleGreen={'Gallery'} className={'ab-center fontSize-onMobile rem-2_5 w-100'}/>)
            case 'contactus':
                return (<HeadingGreenBoxed titleGreen={'Contact'} titleRaw={'Us'}
                                           className={'ab-center fontSize-onMobile rem-2_5 w-100'}/>)
        }
    }
